...
class YogaPoseHistoryDataSourceImpl @Inject constructor(
    ...
    override suspend fun getYogaBestHistories(): Response<List<PoseRecordResponse>> = yogaPoseHistoryApiService.getYogaBestHistories()

    override suspend fun getYogaPoseHistories(): Response<List<PoseRecordResponse>> = yogaPoseHistoryApiService.getYogaPoseHistories()
}